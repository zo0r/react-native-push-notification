...
Since this project probably needs a huge refactor to fix some issues or to implement new features, I think you should probably consider these alternatives: [Notifee](https://notifee.app) free since september or [react-native-notifications](https://github.com/wix/react-native-notifications).

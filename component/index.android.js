...
NotificationsComponent.prototype.addEventListener = function (type, handler) {
  ...
  if (type === 'notification') {
    ...
    listener = DeviceEventEmitter.addListener(NOTIF_ACTION_EVENT, function (
      actionData,
    ) {
...
NotificationsComponent.prototype.getDeliveredNotifications = function (
  callback,
) {
  RNPushNotification.getDeliveredNotifications(callback);
};
NotificationsComponent.prototype.getScheduledLocalNotifications = function (
  callback,
) {
  RNPushNotification.getScheduledLocalNotifications(callback);
};
NotificationsComponent.prototype.removeDeliveredNotifications = function (
  identifiers,
) {
...
NotificationsComponent.prototype.channelExists = function (
  channel_id,
  callback,
) {
...
NotificationsComponent.prototype.createChannel = function (
  channelInfo,
  callback,
) {
...
NotificationsComponent.prototype.channelBlocked = function (
  channel_id,
  callback,
) {
